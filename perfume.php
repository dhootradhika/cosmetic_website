...
<p class="subtitle">Luxury fragrances for your elegance</p>
...
<?php
$result = mysqli_query($conn, "SELECT * FROM products WHERE category='Perfume'");
...
<?php
    ...
    echo "<p>No perfume products found</p>";
}
?>
